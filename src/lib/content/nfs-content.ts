...
export const RISK_ALERTS: RiskAlert[] = [
  ...
  {
    id: "ra-006",
    title: "☢ Natanz Enrichment Activity Surge — IAEA Emergency Session",
    description: "NUR Earth 3D Esri satellite imagery of Natanz confirmed elevated thermal output consistent with cascade expansion. Iran's 60% enriched uranium stockpile now exceeds 164kg — sufficient for 3-4 weapons at 90% weapons-grade. IAEA convened emergency Board session. Israeli Air Force placed on 48-hour readiness. Brent crude risk premium elevated $8-12/bbl. Recommended hedges: long Brent calls, long XAU, reduce TASE exposure.",
    severity: "critical",
    region: "Middle East",
    category: "geopolitical",
    affectedAssets: ["BZ=F", "XAU/USD", "TASE", "URA", "USD/ILS"],
    publishedAt: ago(3),
    active: true,
  },
  {
    id: "ra-007",
    title: "☢ Yongbyon Reprocessing Plant — Active Steam Plume Detected",
    description: "Satellite imagery from Esri World Imagery feed shows active steam plume at Yongbyon 5MW(e) reactor reprocessing building. Assessment: 2-4 weeks from weapons-grade plutonium extraction. DPRK has reportedly conducted 2 ICBM engine tests in 30 days. US-South Korea combined forces at DEFCON 3. KOSPI circuit breakers activated at -8% intraday. JPY safe-haven flows surging.",
    severity: "critical",
    region: "North-East Asia",
    category: "geopolitical",
    affectedAssets: ["KOSPI", "JPY=X", "KRW=X", "XAU/USD", "LMT"],
    publishedAt: ago(6),
    active: true,
  },
  {
    id: "ra-008",
    title: "☢ Pakistan-India Nuclear Posture Escalation — Line of Control Alert",
    description: "Pakistan's Strategic Plans Division placed nuclear-capable Shaheen-III ballistic missiles on enhanced readiness following cross-border exchange at LoC. India's DRDO confirms Agni-V ICBM on launch-ready status. Both nations possess ~330 combined warheads. Financial markets pricing in sub-continental risk: BSE Sensex -3.2%, PKR/USD -6%, gold +2.1%. Nuclear proliferation index at 88/100.",
    severity: "critical",
    region: "South Asia",
    category: "geopolitical",
    affectedAssets: ["SENSEX", "INR=X", "PKR=X", "XAU/USD", "URA"],
    publishedAt: ago(9),
    active: true,
  },
  {
    id: "ra-009",
    title: "☢ Uranium Supply Chain Shock — Kazakhstan Export Halt",
    description: "Kazakhstan's state uranium company Kazatomprom announced force majeure on 30% of contracted deliveries citing pipeline infrastructure damage. Kazakhstan supplies 43% of global uranium. Spot U3O8 surged 18% to $98/lb. Cameco (CCJ) +12%, Uranium ETF (URA) +9.4%. Nuclear utility buyers activating emergency long-term contract provisions. NUR satellite monitoring of Kazakh Inkai and South Inkai mines confirms reduced operational footprint.",
    severity: "high",
    region: "Central Asia",
    category: "market",
    affectedAssets: ["URA", "CCJ", "NLY", "XLU", "BHP"],
    publishedAt: ago(18),
    active: true,
  },
];
