...
const AVATAR_PROFILES: AvatarProfile[] = [
  {
    ...
    description: "Emerald-green eyes, aristocratic feminine elegance, bespoke Italian navy blazer with subtle neckline & fitted skirt. Specialized in high-net-worth liquidity & venture syndicates.",
  ...
  },
  {
    ...
    description: "Intense ocean-blue eyes, muscular athletic build, tailored charcoal Savile Row three-piece suit. Specialized in real-time volatility dispersion & GPU cluster scaling.",
