...
const platformTiers: PlatformTier[] = [
  {
    ...
    price: "Free",
    period: "",
    description: "Access public market data, basic charts, and the financial encyclopedia via browser. No download required.",
    features: [
      "Real-time market overview",
      "Basic charting tools",
      "Financial encyclopedia access",
      "Global news feed",
      "NUR TV live broadcast",
  ...
  {
    id: "compute-access",
    name: "Smart Mining Access",
    price: "Free",
    period: "(smart mining)",
    description: "Full terminal — no subscription. Germany: smart mining off-peak, max €30/mo electricity. All other countries: maximum aggressive mining, no caps. Any GPU ≥4 GB VRAM qualifies.",
    features: [
      "Full terminal download (all 30+ modules)",
      "Country-detected mining schedule (14–24h/day)",
      "Same features as Analyst plan",
      "Min. hardware: 4 GB VRAM, 8 GB RAM",
      "Germany: max €30/mo electricity (auto-throttle)",
      "Other countries: no cap — cheap electricity, max mining",
      "NUR Finance earns: €10–40/mo per device",
      "Switch to Analyst plan anytime",
    ],
    badge: "New",
    color: "#00d4aa",
  },
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {platformTiers.map((tier) => (
              ...
              >
                ...
                <button
                  onClick={() => setActiveView(tier.id === "compute-access" ? "compute-access" : "wallet-gateway")}
                ...
                >
                  {tier.id === "compute-access" ? "Start Mining for Access" : tier.price === "Free" ? "Get Started" : "Subscribe via Crypto"}
                </button>
              </div>
            ))}
          </div>
