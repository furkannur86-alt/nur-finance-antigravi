...
export default function MoodMusicPlayer({ portfolioChangePercent, vix, compact = false }: MoodMusicPlayerProps) {
  ...
  // Pure derivation from props — no need for state+effect to mirror it.
  const mood: MarketMood = computeMarketMood(portfolioChangePercent, vix);
