...
const VIEW_LABELS: Record<string, { label: string; icon: string; color: string }> = {
  ...
  "resource-intelligence": { label: "Resource Intelligence", icon: "💎", color: "#f59e0b" },
  ...
  "galactic-fleet":   { label: "Galactic Fleet",    icon: "🚀", color: "#2E8B57" },
  "orbital-command":  { label: "Orbital Command",   icon: "🛸", color: "#eab308" },
  "civilization-terminals": { label: "Medeniyet Terminalleri", icon: "🏛️", color: "#00f0ff" },
  "civilization-arbitrage": { label: "Filo Arbitraj & OMS",     icon: "⚡", color: "#10b981" },
  "professional-ai":  { label: "Professional AI",   icon: "🩺", color: "#10b981" },
  "professional-social": { label: "Sovereign Social", icon: "👥", color: "#a855f7" },
  "user-profile":     { label: "User Profile",      icon: "👤", color: "#a855f7" },
  "profession-hub":   { label: "Profession Hub",    icon: "🌐", color: "#38bdf8" },
  "wish-framework":   { label: "W.I.S.H. Engine",   icon: "🎯", color: "#10b981" },
  ...
  "fleet-miner":      { label: "Fleet Miner",       icon: "⛏️", color: "#10b981" },
    ...
    <>
      ...
      >
        ...
        <div
          ...
          title="NUR Finance · Click 3 times: Sovereign Login"
        >
        ...
        <button
          ...
          title="Open all modules (Press ` key)"
        >
          {/* Grid icon */}
